...
public class StandardRoom implements RoomInterface {
    ...
    @Override public boolean addReservation(Reservation r) { rsrvtn.add(r); return true; }

    @Override
    public boolean removeReservation(String code) {
        for (Reservation r : rsrvtn) {
            if (r.getCode().equals(code)) { rsrvtn.remove(r); return true; }
        }
        return false;
    }

    @Override public double getPrice() { return hotel.getPrice(); }
